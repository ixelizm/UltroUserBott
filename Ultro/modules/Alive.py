...
from Ultro import app, StartTime, CMD_HELP
...
async def alive(_, m):
    ...
    reply_msg = f"**[UltroBot](https://github.com/ixelizm/UltroUserbott)**\n"
...
async def pingme(_, message: Message):
    ...
    await message.edit(f"**[[Owner]](https://t.me/ixelizm)** \n**Ping Speed** **[DC-{app_info.dc_id}]**: `{m_s} ms`", disable_web_page_preview=True)

CMD_HELP.update(
    {
        "Alive": """
**Alive Plugini**
  `.alive` -> Bot aktifliğini kontrol eder.
  `.ping` -> standart ping komutu.
"""
    }
)
